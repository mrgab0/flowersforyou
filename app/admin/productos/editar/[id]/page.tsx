    ...
    <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-2xl mx-auto">
      ...
      <form action={updateProductWithId} className="space-y-6">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input name="image" defaultValue={product.images[0]} placeholder="https://images.unsplash.com/..." className="p-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#D81B60]" required />
        </div>
