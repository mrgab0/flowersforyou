...
const I18N_CONTENT = {
  es: {
    ...
    welcomeMessage: "¡Hola! 🌸 Soy **Sofia** de *Flowers For You* en Houston.\n\n¿Para qué ocasión especial estás buscando flores hoy?",
    resetMessage: "¡Hola de nuevo! 🌸 ¿En qué te puedo ayudar?",
    errorMessage: "🌸 Hubo un pequeño inconveniente de conexión. Puedes escribirnos directo a nuestro WhatsApp [+1 657-698-8586](https://wa.me/16576988586) para asistirte de inmediato.",
    defaultErrorResponse: "Disculpa, no pude procesar tu solicitud. Por favor intenta nuevamente.",
    advisorRole: "FLOWERS FOR YOU • ASESORA FLORAL",
    liveBadge: "EN LÍNEA",
    headerStatus: "Asesora Floral • En línea 🌸",
    ariaOpen: "Abrir Asistente Floral Flowers For You",
    ariaRestart: "Reiniciar chat",
    ariaClose: "Cerrar chat",
    ariaSend: "Enviar mensaje",
    searchingCatalog: "Sofia está escribiendo...",
    popularQuestions: "Consultas populares:",
    inputPlaceholder: "Escribe tu consulta aquí...",
    poweredBy: "Asistente Floral • Flowers For You",
  },
  en: {
    quickQuestions: [
    ...
    welcomeMessage: "Hello! 🌸 I'm **Sofia** at *Flowers For You* in Houston.\n\nWhat special occasion are you looking for flowers for today?",
    resetMessage: "Hello again! 🌸 How can I help you today?",
    errorMessage: "🌸 There was a brief connection issue. You can message us directly on WhatsApp [+1 657-698-8586](https://wa.me/16576988586) for instant assistance.",
    defaultErrorResponse: "Sorry, I couldn't process your request. Please try again.",
    advisorRole: "FLOWERS FOR YOU • FLORAL ADVISOR",
    liveBadge: "ONLINE",
    headerStatus: "Floral Advisor • Online 🌸",
    ariaOpen: "Open Flowers For You Floral Assistant",
    ariaRestart: "Restart chat",
    ariaClose: "Close chat",
    ariaSend: "Send message",
    searchingCatalog: "Sofia is typing...",
    popularQuestions: "Popular questions:",
    inputPlaceholder: "Type your message here...",
    poweredBy: "Floral Advisor • Flowers For You",
  }
};
...
export const ChatbotModal = () => {
  ...
  }, [currentLocale, content.welcomeMessage]);
  ...
  return (
    <>
      ...
      {!isOpen && (
        ...
        >
          <div className="flex items-center gap-2.5 sm:gap-3.5 bg-white/95 dark:bg-[#12131a]/95 backdrop-blur-md pl-2 pr-3.5 sm:pr-4 py-2 rounded-2xl shadow-[0px_10px_35px_rgba(255,151,164,0.3)] dark:shadow-[0px_10px_35px_rgba(0,0,0,0.6)] border-2 border-[#D4AF37]/80 hover:border-[#D4AF37] hover:shadow-[0px_12px_40px_rgba(255,151,164,0.4)] transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] max-w-[310px] sm:max-w-none">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl overflow-hidden border border-[#D4AF37] shadow-sm relative group-hover:scale-105 transition-transform duration-300 bg-[#2a0002]">
                <img
                  src="/logo.jpg"
                  alt="Flowers For You Asesora IA"
            ...
            <div className="flex-shrink-0 bg-gradient-to-r from-[#8B0024] to-[#FF97A4] text-white p-2 rounded-xl shadow-md group-hover:opacity-95 transition-opacity flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  <span className="font-bold text-sm text-white">Sofia</span>
