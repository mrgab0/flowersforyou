...
export const ProductCard = ({ name, slug, price, image, category }: ProductCardProps) => {
  return (
      ...
      <div className="group relative bg-white rounded-2xl transition-all duration-500 overflow-hidden shadow-[0px_4px_20px_rgba(0,0,0,0.04)] hover:shadow-[0px_12px_30px_rgba(0,0,0,0.08)]">
        ...
        <div className="p-6">
          ...
          <div className="flex items-end justify-between mt-4">
            ...
            <button className="bg-[#FF97A4] text-white px-5 py-2.5 rounded-lg hover:bg-[#B0004A] active:scale-95 transition-all duration-300 font-bold text-sm shadow-md shadow-[#FF97A4]/20">
              Ver Detalle
            </button>
          </div>
        </div>
